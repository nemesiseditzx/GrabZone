...
(function(){
 ...
 if(/vendor\.html$/i.test(location.pathname)){addCss('marketplace-vendor.css','data-gz-marketplace-vendor-css');addJs('marketplace-vendor-enhance.js','data-gz-marketplace-vendor-enhance-js');addJs('marketplace-vendor-email.js','data-gz-marketplace-vendor-email-js');addJs('marketplace-vendor-shipment.js','data-gz-marketplace-vendor-shipment-js');addJs('marketplace-vendor-product-edit.js','data-gz-marketplace-vendor-product-edit-js')}
