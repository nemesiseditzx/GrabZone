...
const VENDOR_PRODUCT_EDITOR=`<script>if(!document.querySelector('script[data-gz-vendor-product-editor]')){const s=document.createElement('script');s.src='/vendor-control-product-editor.js?v=20260921-v18';s.setAttribute('data-gz-vendor-product-editor','1');document.head.appendChild(s)}</script>`;
