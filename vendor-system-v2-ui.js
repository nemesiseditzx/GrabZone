...
async function customerVariations(){
 ...
 function intercept(e){
   ...
   if(current.status!=='Available'||(current.stock_mode==='tracked'&&Number(current.effective_stock??current.stock??0)<selectedQty)){e.preventDefault();e.stopImmediatePropagation();alert('This variation is out of stock.');return}
