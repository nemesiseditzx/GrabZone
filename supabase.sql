...
/* =========================================================
   ...
   Added for the homepage promotional billboard.
========================================================= */
...
insert into public.billboard_settings(id) values(1) on conflict(id) do nothing;
...
create policy "public read active billboards" on public.billboards for select using (active = true);

drop policy if exists "authenticated manage billboards" on public.billboards;
create policy "authenticated manage billboards" on public.billboards for all to authenticated using (true) with check (true);

drop policy if exists "public read billboard settings" on public.billboard_settings;
create policy "public read billboard settings" on public.billboard_settings for select using (true);

drop policy if exists "authenticated manage billboard settings" on public.billboard_settings;
create policy "authenticated manage billboard settings" on public.billboard_settings for all to authenticated using (true) with check (true);
