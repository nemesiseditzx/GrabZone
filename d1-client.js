...
try{const pagePath=String(location.pathname||'').replace(/\/+$/,'').toLowerCase();const isGrabPointsPage=pagePath==='\/grabpoints'||pagePath==='\/grabpoints.html'||pagePath.endsWith('\/grabpoints')||pagePath.endsWith('\/grabpoints.html');if(isGrabPointsPage){const s=document.createElement('script');s.src='grabpoints-auth-animation.js?v=20260908ui4';s.async=true;document.head.appendChild(s);const rp=document.createElement('script');rp.src='grabpoints-redeem-polish.js?v=20260908polish2';rp.async=true;document.head.appendChild(rp)}}catch{}
})();