...
if first<0 or second<0: raise SystemExit(f'expected two showVerify functions; first={first}, second={second}')
end=s.find('\n',second)
if end<0: raise SystemExit('legacy showVerify end not found')
s=s[:second]+s[end+1:]
