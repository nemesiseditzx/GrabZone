...
export default{async fetch(req,env,ctx){try{const rawPath=new URL(req.url).pathname;
  ...
  if(p==='/api/vendor/dashboard'||p==='/api/vendor/products'||p==='/api/vendor/orders'||p==='/api/vendor/profile'||p==='/api/vendor/sections'||p==='/api/vendor/shipments'||p==='/api/vendor/order-status'){
