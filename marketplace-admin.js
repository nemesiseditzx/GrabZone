...
const uploadAdminImage=async(file,kind,vendorId)=>{
 ...
 const fd=new FormData();fd.append('file',file,file.name);fd.append('kind',kind);if(vendorId)fd.append('vendor_id',vendorId);
